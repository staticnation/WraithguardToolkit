...
from mlox_subset.nif import NifParseError, read_nif
...
def survey(root: Path, limit: int) -> int:
...
def verify(root: Path, report_path: Path | None, collect_dir: Path | None, limit: int) -> int:
    ...
    This needs no external reference. The scan in :mod:`mlox_subset.nif.scan`
