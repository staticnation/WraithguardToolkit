"""Shared foundation package for Wraithguard Toolkit.

This package holds the cross-cutting concerns that both the engine
(``wraithguard_toolkit.py``) and the GUI (``wraithguard_toolkit_gui.py``) depend
...
Example:
    >>> from wraithguard import get_logger, setup_logging, _
...
from wraithguard.logging_setup import (
    LogLevel,
    add_log_handler,
    get_logger,
    setup_logging,
