...
:mod:`wraithguard.tes3fields.landscape` and :mod:`~.pathgrid`, which know their
...
from wraithguard.tes3fields.naming import record_for, subrecord_for

if TYPE_CHECKING:
    from wraithguard.tes3fields.schema_types import Record
