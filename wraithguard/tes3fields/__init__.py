...
Scripts are handled by :mod:`wraithguard.mwscript`; the record types here are
...
from wraithguard.tes3fields.pathgrid import PathGridDecodeError, render_connections
