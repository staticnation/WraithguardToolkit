...
place" split :mod:`~wraithguard.viz.terrain3d` uses for its plugin switcher.
"""
...
from wraithguard.tes3fields.pathgrid import PathGridDecodeError, _point_fields, decode_connections
...
def build_pathgrid_graph(
    ...
    *,
    ...
    :func:`~wraithguard.viz.terrain3d.build_terrain_3d`'s pattern of decoding
