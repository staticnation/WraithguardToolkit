...
``CellConflicts.by_plugin`` (see :mod:`~wraithguard.viz.geometry`) and
...
from wraithguard import _, ngettext
from wraithguard.viz import html as h
from wraithguard.viz.geometry import Cell, CellConflicts, bounds, group_by_cell, parse_grid
...
def cells_with_conflicts(conflicts: Iterable[Mapping[str, Any]]) -> set[tuple[int, int]]:
    ...
    Returns:
        ...
        :class:`~wraithguard.viz.geometry.Cell`.
    """
