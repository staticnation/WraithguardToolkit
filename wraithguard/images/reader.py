...
nothing complains. :mod:`wraithguard.nif.textures` already resolves a reference
...
from wraithguard.images.bitmap import MAGIC as BMP_MAGIC, read_bmp
from wraithguard.images.dds import MAGIC as DDS_MAGIC, read_dds
from wraithguard.images.image import Image, ImageError
from wraithguard.images.png import encode_png
from wraithguard.images.targa import read_tga
