...
The reader and :mod:`mlox_subset.nif.report` can already say what a mesh holds
...
:func:`~mlox_subset.nif.report.compare` refuses to call an absence a loss when
...
from mlox_subset.nif.report import compare, summarise

if TYPE_CHECKING:
    from pathlib import Path

    from mlox_subset.nif.report import Difference, Structure
...
class MeshFinding:
    ...
    :class:`~mlox_subset.nif.report.Difference`.
...
class MeshAnalyser:
    ...
    def structure(self, path: Path, digest: str = "") -> Structure | str:
        ...
        Returns:
            Its :class:`~mlox_subset.nif.report.Structure`, or a string
