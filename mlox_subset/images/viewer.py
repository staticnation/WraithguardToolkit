...
The numbers in :class:`~mlox_subset.images.compare.Comparison` say *how much*
...
from mlox_subset.images.compare import Verdict
from mlox_subset.logging_setup import get_logger

if TYPE_CHECKING:
    from mlox_subset.images.compare import Comparison
...
def build_compare_page(
    ...
    *,
    ...
    Args:
        ...
        outcome: What :func:`~mlox_subset.images.compare.compare_images` found.
