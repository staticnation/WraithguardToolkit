...
flowchart TD
  ...
  subgraph SG2["tests.test_configurator"]
  ...
  subgraph SG3["tests.test_docs_render"]
  ...
  subgraph SG4["tests.test_foundation"]
  ...
  subgraph SG5["tests.test_generated_js"]
  ...
  subgraph SG6["tests.test_gui_smoke"]
  ...
  subgraph SG7["tests.test_hardening"]
  ...
  subgraph SG8["tests.test_i18n_placeholders"]
  ...
  subgraph SG9["tests.test_image_compare"]
  ...
  subgraph SG10["tests.test_images"]
  ...
  subgraph SG11["tests.test_integration"]
  ...
  subgraph SG12["tests.test_land_diff"]
  ...
  subgraph SG13["tests.test_land_emit"]
  ...
  subgraph SG14["tests.test_land_fidelity"]
  ...
  subgraph SG15["tests.test_land_heights"]
  ...
  subgraph SG16["tests.test_land_landmass"]
  ...
  subgraph SG17["tests.test_land_merge"]
  ...
  subgraph SG18["tests.test_land_native"]
  ...
  subgraph SG19["tests.test_land_service"]
  ...
  subgraph SG20["tests.test_merged_lands_coverage"]
  ...
  subgraph SG21["tests.test_mesh_conflicts"]
  ...
  subgraph SG22["tests.test_mesh_from_archive"]
    n_tests_test_mesh_from_archive_TestTheArchiveIsTried["TestTheArchiveIsTried"]
  end
  subgraph SG23["tests.test_mwscript"]
  ...
  subgraph SG25["tests.test_nif_analysis"]
  ...
  subgraph SG26["tests.test_nif_geometry"]
  ...
  subgraph SG27["tests.test_nif_serve"]
  ...
  subgraph SG28["tests.test_nif_textures"]
  ...
  subgraph SG29["tests.test_nif_viewer"]
  ...
  subgraph SG30["tests.test_patch_align"]
  ...
  subgraph SG31["tests.test_patch_dialogue"]
  ...
  subgraph SG32["tests.test_patch_merge"]
  ...
  subgraph SG33["tests.test_patch_queue"]
  ...
  subgraph SG34["tests.test_patch_records"]
  ...
  subgraph SG35["tests.test_patch_status"]
  ...
  subgraph SG36["tests.test_patch_summary"]
  ...
  subgraph SG37["tests.test_plugins"]
  ...
  subgraph SG38["tests.test_record_subset"]
  ...
  subgraph SG39["tests.test_replace_notes"]
  ...
  subgraph SG40["tests.test_rule_authoring"]
  ...
  subgraph SG41["tests.test_rule_derive"]
  ...
  subgraph SG42["tests.test_rule_maker"]
  ...
  subgraph SG43["tests.test_rule_parser"]
  ...
  subgraph SG45["tests.test_standards"]
    n_tests_test_standards_TestNoReExportShim["TestNoReExportShim"]
  end
  subgraph SG46["tests.test_survey_landscape"]
  ...
  subgraph SG47["tests.test_tes3_schema"]
  ...
  subgraph SG48["tests.test_tes3fields"]
  ...
  subgraph SG49["tests.test_toml_equivalence"]
  ...
  subgraph SG50["tests.test_unreached_api"]
  ...
  subgraph SG51["tests.test_updaters"]
  ...
  subgraph SG53["tests.test_viz_pages"]
  ...
  subgraph SG72["wraithguard.land.emit"]
    n_wraithguard_land_emit_EmitError["EmitError"]
  end
  subgraph SG73["wraithguard.land.heights"]
    n_wraithguard_land_heights_HeightEncodeError["HeightEncodeError"]
  end
  subgraph SG74["wraithguard.land.landmass"]
  ...
  subgraph SG75["wraithguard.land.merge"]
  ...
  subgraph SG76["wraithguard.land.meta"]
  ...
  subgraph SG90["wraithguard.nif.geometry"]
  ...
  subgraph SG91["wraithguard.nif.reader"]
  ...
  subgraph SG92["wraithguard.nif.report"]
  ...
  subgraph SG102["wraithguard.patch.summary"]
  ...
  subgraph SG103["wraithguard.plugins.metadata"]
    n_wraithguard_plugins_metadata_PluginFileIndex["PluginFileIndex"]
  end
  subgraph SG104["wraithguard.rules.authoring"]
  ...
  n_wraithguard_toolkit_gui_App -->|extends| n_wraithguard_gui_t3_Tes3cmdMixin
  n_wraithguard_toolkit_gui_App -->|extends| n_wraithguard_gui_conflicts_ConflictWindowsMixin
  n_wraithguard_toolkit_gui_App -->|extends| n_wraithguard_gui_patchwin_PatchBuilderMixin
  n_wraithguard_toolkit_gui_App -->|extends| n_wraithguard_gui_pluginview_PluginViewMixin
